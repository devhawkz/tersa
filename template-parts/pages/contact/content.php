...
$phone            = $get ? $get('contact_phone', '+385 98 252 562') : '+385 98 252 562';
$phone_second     = $get ? $get('contact_phone_second', '+385 98 252 562') : '+385 98 252 562';
...
$email            = $get ? $get('contact_email', 'tersa@tersa.hr') : 'tersa@tersa.hr';
...
$hq_address       = $get ? $get('contact_hq_address', __('Nikole Tesle 71, 31553 Črnkovci', 'tersa-shop')) : __('Nikole Tesle 71, 31553 Črnkovci', 'tersa-shop');
		...
		<div class="contact-card card">
			<div class="contact-card__grid">
				<div class="contact-card__info">
					...
					<div class="contact-card__block">
						<p style="margin:0">
							<a href="tel:<?php echo esc_attr($phone_href); ?>"><?php echo esc_html($phone_second); ?></a>
						</p>
				...
				<div class="contact-card__form">
					...
					<div class="contact-card__form-wrap">
						<?php if (function_exists('do_shortcode')) :
							echo do_shortcode('[contact-form-7 id="6a84fef" title="Kontakt"]');
