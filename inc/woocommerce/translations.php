...
require_once __DIR__ . '/translations-register-wishlist.php';        // Polylang register strings (wishlist)
require_once __DIR__ . '/translations-register-general-shop.php';     // Polylang register strings (shop UI/catalog)
