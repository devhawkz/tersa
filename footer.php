...
?>
	...
	<li class="site-footer__payment-badge" aria-label="<?php esc_attr_e('Google Pay', 'tersa-shop'); ?>">
		...
		<span class="screen-reader-text"><?php esc_html_e('Google Pay', 'tersa-shop'); ?></span>
	</li>
</ul>
				</div>
			</div>
